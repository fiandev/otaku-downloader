...
class Downloader {
  static async zippy(url) {
    if (new Date().getTime() > new Date("31, march 2023 23:59:59").getTime()) throw "since 31 march 2023 at 23:59:59, the zippyshare file hosting has been shutdown permanently";
    try {
